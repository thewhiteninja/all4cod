...
// Fichier généré le 19/02/2006 15:32:14 depuis la bibliothèque de types ci-dessous.
...
// Erreurs :
//   Conseil : Membre 'Type' de 'IWebBrowser' modifié en 'Type_'
//   Remarque : paramètre 'Type' dans IWebBrowser.Type changé en 'Type_'
//   Remarque : paramètre 'Property' dans DWebBrowserEvents.PropertyChange changé en 'Property_'
//   Remarque : paramètre 'Property' dans IWebBrowserApp.PutProperty changé en 'Property_'
//   Remarque : paramètre 'Property' dans IWebBrowserApp.GetProperty changé en 'Property_'
//   Remarque : paramètre 'Type' dans IShellUIHelper.AddDesktopComponent changé en 'Type_'
//   Remarque : paramètre 'var' dans IShellNameSpace.Expand changé en 'var_'
// ************************************************************************ //
...
// *********************************************************************//
// Constantes pour enum CommandStateChangeConstants
type
...
// Constantes pour enum OLECMDEXECOPT
type
...
// Constantes pour enum tagREADYSTATE
type
...
// Constantes pour enum SecureLockIconConstants
type
...
// Constantes pour enum ShellWindowTypeConstants
type
...
// Constantes pour enum ShellWindowFindWindowOptions
type
...
// Nom du contrôle      : TWebBrowser_V1
// Chaîne d'aide        : WebBrowser Control
// Interface par défaut : IWebBrowser
// DISP Int. Déf. ?     : No
// Interface événements : DWebBrowserEvents
...
// *********************************************************************//
// Déclaration de classe proxy de contrôle OLE
// Nom du contrôle      : TWebBrowser
// Chaîne d'aide        : WebBrowser Control
// Interface par défaut : IWebBrowser2
// DISP Int. Déf. ?     : No
// Interface événements : DWebBrowserEvents2
// TypeFlags            : (34) CanCreate Control
// *********************************************************************//
...
// *********************************************************************//
// La classe CoInternetExplorer fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IWebBrowser2 exposée             
// par la CoClasse InternetExplorer. Les fonctions sont destinées à être utilisées par            
...
// *********************************************************************//
// La classe CoShellBrowserWindow fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IWebBrowser2 exposée             
// par la CoClasse ShellBrowserWindow. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoShellWindows fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IShellWindows exposée             
// par la CoClasse ShellWindows. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoShellUIHelper fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IShellUIHelper exposée             
// par la CoClasse ShellUIHelper. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoShellNameSpace fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IShellNameSpace exposée             
// par la CoClasse ShellNameSpace. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoShellShellNameSpace fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IShellNameSpace exposée             
// par la CoClasse ShellShellNameSpace. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoCScriptErrorList fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IScriptErrorList exposée             
// par la CoClasse CScriptErrorList. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoSearchAssistantOC fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut ISearchAssistantOC3 exposée             
// par la CoClasse SearchAssistantOC. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoShellSearchAssistantOC fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut ISearchAssistantOC3 exposée             
// par la CoClasse ShellSearchAssistantOC. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
